...
class Game {
    constructor() {
        ...
        this.shopPool = []
        this.dominoPool = []
        this.standartPoolCount = 7 // изначальное кол-во домино 
    }
    start() {
        this.setRandomPool()
        this.renderDominoPool()
    }
    renderDominoPool() { // установить пул для 2 игроков и для базара
        ...
        for (let i in this.userPool) {
            ...
            userDomino.src = this.userPool[i]._image
            ...
            opponentDomino.src = this.opponentPool[i]._image
